...
export default function CompaniesPage() {
  ...
  // Debug: Log the companies state to confirm updates
  console.log("Companies in CompaniesPage:", companies);
  ...
  if (!Array.isArray(companies) || companies.length === 0) {
    return <div className="text-center p-6">No companies found.</div>;
  }
